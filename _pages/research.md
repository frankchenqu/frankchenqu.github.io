...
{% include figure image_path="/assets/images/AIPadv2023TOC.jpg" caption="The Failure of Bosanquet Equation to Predict Diffusivities of Fluids inside Nanotubes" %}
...
{% include figure image_path="/assets/images/MS2023TOC.tif" caption="The Absorption of CO<sub>2</sub> in Four Physical Solvents using the Continuous Fractional Component Monte Carlo Method" %}
...
{% include figure image_path="/assets/images/ACSOMEGA2021TOC.tif" caption="The Release of a Peptide Drug from Carbon Nanotubes in an Electric Field" %}
